...
error_configs = set()
error_apis = set()
with open("test_pipline/gpu_bigtensor/gpu_bigtensor_accuracy/error_log.log", "w") as error_log:
    for i in range(8):
...
with open(
    "test_pipline/gpu_bigtensor/gpu_bigtensor_accuracy/error_config.txt", "w"
) as error_config_file:
    for config in error_configs:
        error_config_file.write(config)
with open("test_pipline/gpu_bigtensor/gpu_bigtensor_accuracy/error_api.txt", "w") as error_api_file:
